...
case 'play2': {
    ...
    if (!text) {
        await sock.sendMessage(msg.key.remoteJid, {
            text: `${e} Usa el comando correctamente:\n\n📌 Ejemplo: *${global.prefix}play2* diles`
        }, { quoted: msg });
        break;
    }
...
case 'play3': {
    ...
    if (!text) {
        await sock.sendMessage(msg.key.remoteJid, {
            text: `${e} Escribe lo que deseas buscar en Spotify.\nEjemplo: *${global.prefix}play3* Marshmello - Alone`
        }, { quoted: msg });
        break;
    }
...
await sock.sendMessage2(
  chatId,
  {
    image: { url: "https://files.catbox.moe/fd7x3t.jpg" }, 
    caption: captionText 
  },
  msg 
);
...
await sock.sendMessage2(
  chatId,
  {
    image: { url: "https://files.catbox.moe/nsfx7f.jpg" }, 
    caption: menuText
  },
  msg 
);
...
╰─────────────────╯`;
  ...
  chatId,
  {
    image: { url: "https://files.catbox.moe/p3wdxz.jpg" }, 
    caption: captionText 
  },
  msg 
)
...
╰✦ ${global.prefix}add`;
  ...
  chatId,
  {
    image: { url: "https://files.catbox.moe/cbagtg.jpg" }, 
    caption: captionText 
  },
  msg
)
