...
`.trim();
    ...
    await conn.sendMessage(chatId, { text: caption, contextInfo: { externalAdReply: { title: title, body: textbot, thumbnailUrl: thumbnail, thumbnail: thumbnail, sourceUrl: thumbnail, mediaType: 1, showAdAttribution: true, renderLargerThumbnail: true }}} , { quoted: msg })
/*await conn.sendMessage(chatId, {
      text: caption,
      contextInfo: {
        externalAdReply: {
