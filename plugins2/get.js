...
const handler = async (msg, { conn }) => {
  ...
  if (!quotedMsg) {
    return await conn.sendMessage2(msg.key.remoteJid, {
      text: `${e} Error: Debes responder a un estado de WhatsApp para descargarlo.`
    }, msg );
  }
  ...
  if (quotedMsg.imageMessage) {
    ...
    return await conn.sendMessage2(msg.key.remoteJid, {
      text: `${e} *Error:* Solo puedes descargar *imágenes, videos, audios y textos* de estados de WhatsApp.`
    }, msg );
  }
  ...
  if (mediaType === "text") {
    ...
    await conn.sendMessage2(msg.key.remoteJid, {
      image: buffer,
      caption: `${e} *Estado de texto convertido en imagen*`
    }, msg );
    ...
    if (!mediaStream || mediaStream.length === 0) {
      return await conn.sendMessage2(msg.key.remoteJid, {
        text: `${e} *Error:* No se pudo descargar el estado. Intenta de nuevo.`
      }, msg );
    }
